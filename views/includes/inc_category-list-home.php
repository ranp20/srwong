      ...
      <div class="categories-list-home owl-carousel owl-theme row">
        ...
        <div class='item'>
          <div class='category-wrapper mb-25'>
            <div class='category-img'>
              <a href='./category/name_category' class='category-img__linkcateg'>
                <img src='./views/assets/img/product/mostricrunh.jpg' alt=''>
              </a>
            </div>
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>ENTRADAS</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>ASADOS</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>CHAUFAS</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>AEROPUERTO</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>SOPAS</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>TALLARINES</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>ALITAS FRITAS</a>
              </h4>
            </div>
          </div>
        </div>
        <div class='item'>
          <div class='category-wrapper mb-25'>
            ...
            <div class='category-content'>
              <h4 class='text-center'>
                <a href='./category/name_category'>A LA PLANCHA</a>
              </h4>
            </div>
          </div>
        </div>

...
$(() => {
    ...
    // ------------ ENVIAR CORREO PARA LA RECUPERACIÓN DE CONTRASEÑA
    $(document).on("submit","#frm-restorepass_ussRecov",function(e){
       e.preventDefault();
       var _tokengen = $("#u-s_tokenbygetclient-sis").val();
       var pass1 = $("#usr-recovpass").val();
       var pass2 = $("#usr-repeat_recovpass").val();
       
       if(pass1 == pass2){
            $.ajax({
                url: "./controllers/prcss_restore-password.php",
                method: "POST",
                dataType: 'JSON',
                contentType: 'application/x-www-form-urlencoded;charset=UTF-8',
                data: { tokenreturn : _tokengen, pass_restore : pass2},
                beforeSend: function(){
                        ...
                        if(e.r == "true"){
                            Swal.fire({
                		        ...
                		        html: `<div class="alertSwal">
                			            ...
                			            <div class="alertSwal__cText">
                			              <p>Se reestableció correctamenre. Inicie sesión con su nueva contraseña.</strong></p>
                			            </div>
                            ...
                            Swal.fire({
                		        ...
                		        html: `<div class="alertSwal">
                			            ...
                			            <div class="alertSwal__cText">
                			              <p>Lo sentimos, hubo un error al reestablecer la contraseña.</strong></p>
                			            </div>
                			            <button type="button" role="button" tabindex="0" class="SwalBtn1 customSwalBtn">Aceptar</button>
                			          </div>`,
                		        icon: 'error',
            ...
            Swal.fire({
		        ...
		        html: `<div class="alertSwal">
			            ...
			            <div class="alertSwal__cText">
			              <p>Las contraseñas deben ser iguales.</strong></p>
			            </div>
			            <button type="button" role="button" tabindex="0" class="SwalBtn1 customSwalBtn">Aceptar</button>
			          </div>`,
		        icon: 'error',

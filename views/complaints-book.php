...
$listAllbranches = $dmlBranches->listAllBranches();
?>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <div class="m-auto col-lg-10 col-md-12 col-sm-12 col-12">
              <div class="chcksel-frm-cont">
                ...
                <div class="c_complaints-book__c--cContent">
                  <div class="page-body">
                    <h5 class="data-wky_frmtcode" style="text-align: center;">HOJA DE RECLAMACIÓN <span id="cod_gencomplbook">SR-WNG-001-563669</span></h5>
                    ...
                    <div class="body">
                      <div class="formulario" class="c_complaints-book__c--cContent__frm">
                        ...
                        <!--<form autocomplete="off" method="POST" id="sr-frm_complaints-book">-->
                          <p class="spn-help_usr">1. Selección de sucursal</p>
                          <div class="form-group">
                            <div class="mb-3">
                              <!-- <label for="">Sucursal <span><em>*</em></span></label> -->
                              <div class="select-distrito-box">
                                <select id="cmpbk-book_seldistric" name="cmpbk-book_seldistric" required>
                                  <?php
                                    $tmpBranches = "";
                                    $tmpBranches .= "<option selected='selected' disabled='disabled' value='' required>Seleccione...</option>";
                                    if(count($listAllbranches) > 0){                                    
                                      foreach($listAllbranches as $k => $v){
                                        $tmpBranches .= "<option value='{$v['id']}'>{$v['name']}</option>";
                                      }
                                    }
                                    echo $tmpBranches;
                                  ?>
